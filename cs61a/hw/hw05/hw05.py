...
class MissManners:
    ...
    def ask(self, message, *args):
        ...
        if hasattr(self.obj, machine):
            return getattr(self.obj, machine)(*args)
        else:
            return 'Thanks for asking, but I know not how to {0}.'.format(machine)
# Trees
...
def add_d_leaves(t, v):
    ...
    def helper(t, d):
        for b in t.branches:
            helper(b, d+1)
        t.branches.extend([Tree (v) for i in range(d)])
    helper(t, 0)
